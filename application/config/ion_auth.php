...
$config['error_start_delimiter']   = '<p style="margin-top:-1em"><i class="fa fa-bell" aria-hidden="true"></i>';		// Error message start delimiter
$config['error_end_delimiter']     = '<p style="margin-top:-1em">';	// Error message end delimiter
